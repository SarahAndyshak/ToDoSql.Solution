UPDATE TO README FOR SQL: 
1. Before running the project, open the .gitignore file and add "appsettins.json", "bin", and "obj" to the ignored file list.  
2. Create a file called appsettings.json in the main project. Add your SQL connection string (below). Be sure to replace your username, password, and name of your database for the fields YOUR-USER-HERE, YOUR-PASSWORD-HERE, AND YOUR-DB-NAME:
{
  "ConnectionStrings": {
...
This project is branch 9_static_content_layouts_and_partials (use if pushing to github).
